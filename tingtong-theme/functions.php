...
function tt_enqueue_and_localize_scripts() {
	// Rejestracja i dołączenie głównego arkusza stylów.
	wp_enqueue_style( 'tingtong-main-styles', get_template_directory_uri() . '/assets/css/main-styles.css', array(), '1.0.0' );

	// Rejestracja i dołączenie głównego skryptu aplikacji.
	wp_enqueue_script( 'tingtong-main-app', get_template_directory_uri() . '/assets/js/main-app.js', array(), '1.0.0', true );

	// Przekazanie danych do skryptu (lokalizacja).
	wp_localize_script(
		'tingtong-main-app',
		'TingTongData',
		[
